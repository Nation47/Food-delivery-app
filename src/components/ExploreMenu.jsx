    ...
    return (
        <>
            <div className="flex flex-col gap-5 m-auto max-w-6xl my-6 ">
                ...
                <div className="flex justify-between items-center my-5 mx-0 snap-x overflow-x-scroll gap-6 text-center">
                    {menuList.map((item,index) => {
                        return(
                            <div className="snap-center" onClick={() => setCategory(prev => prev === item.name? "All": item.name)} key={index}>
